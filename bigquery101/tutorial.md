...
<walkthrough-spotlight-pointer cssSelector="cfc-left-panel-content cfc-panel.cec-panel-center" single="true">**︙**(三点リーダー)</walkthrough-spotlight-pointer> をクリックし、[**データセットを作成**] を選択します。
